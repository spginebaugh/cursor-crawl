 ...
 */
export const getLineNumber = (sourceFile: ts.SourceFile, position: number): number => {
 ...
 */
export const extractCodeSnippet = (sourceFile: ts.SourceFile, node: ts.Node): string => {
 ...
 */
export const arraysHaveSameItems = <T>(arr1: T[], arr2: T[]): boolean => {
